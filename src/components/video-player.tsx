...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  const [playbackQuality, setPlaybackQuality] = useState<'high' | 'low'>('high');
  ...
  }, [onLoadStart, onLoadedData, onError, checkBufferHealth, detectNetworkQuality, enableAdaptiveQuality]);
  ...
  return (
    <div className={`video-container ${className || ''}`} style={{ position: 'relative' }}>
      ...
      {isBuffering && (
        ...
        >
          {connectionQuality === 'poor' ? 'Optimizing for slow connection...' : 'Buffering...'}
        </div>
      )}
